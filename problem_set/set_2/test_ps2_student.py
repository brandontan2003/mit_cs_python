...
from problem_set.set_2.hangman import has_player_won, get_word_progress, get_available_letters, hangman
...
class TestPS2(unittest.TestCase):
    ...
    def test_has_player_won(self):
        self.assertTrue(has_player_won('face', ['f','c','a','e']))
        self.assertFalse(has_player_won('moves', ['o','c','a','v','e']))

    def test_has_player_won_repeated_letters(self):
        self.assertTrue(has_player_won('bass', ['a','s','b','e']),
            "Failed with repeated letters")
        self.assertFalse(has_player_won('rare', ['f','t','r','e']),
            "Failed with repeated letters")

    def test_has_player_won_empty_string(self):
        self.assertTrue(has_player_won('', ['f','c','y','e']),
            "Failed with the empty string")

    def test_has_player_won_empty_list(self):
        self.assertFalse(has_player_won('code', []),
    ...
    def test_get_available_letters(self):
        self.assertEqual(get_available_letters(['a','b','c','d']), 'efghijklmnopqrstuvwxyz')
        self.assertEqual(get_available_letters(['z','p','x','b', 'b']), 'acdefghijklmnoqrstuvwy')
        self.assertEqual(get_available_letters(['a','u','i','o','w']), 'bcdefghjklmnpqrstvxyz')

    def test_get_available_letters_empty_string(self):
        self.assertEqual(get_available_letters(list(string.ascii_lowercase)), '',
            "Failed to return the empty string")

    def test_get_available_letters_empty_list(self):
        self.assertEqual(get_available_letters([]), 'abcdefghijklmnopqrstuvwxyz',
            "Failed with the empty list")
