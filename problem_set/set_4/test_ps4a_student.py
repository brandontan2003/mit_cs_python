...
class TestPS4A(unittest.TestCase):
    ...
    def test_tree_height(self):
        answers = [5, 6, 2, 0]
        tr1 = Node(13, Node(10, Node(5, Node(4), Node(6)), Node(11)),
                   Node(15, right_child=Node(16, Node(3, Node(20, Node(17))))))
        tr2 = Node(37, Node(24, Node(7, Node(2, right_child=Node(5))), Node(32)),
                   Node(42, Node(40), Node(42, right_child=Node(43, Node(2, Node(14, Node(30)))))))
    ...
    def test_tree_height_additional(self):
        ...
        tr2 = Node(5, right_child=Node(7, right_child=Node(9, right_child=Node(10, right_child=Node(11,
                                                                                                    right_child=Node(90,
                                                                                                                     Node(
                                                                                                                         2)))))))
        tr3 = Node(5)
